-- =============================================================================
-- V018: Phase 1 bootstrap/RBAC hardening
--
-- This migration makes the Phase 1 final state explicit for environments that
-- may already have applied the earlier V016/V017 drafts.
-- =============================================================================
...
VALUES
    ...
    ('role-platform-bootstrap', 'BOOTSTRAP', '平台首启引导账号',
     'Passwordless first-admin setup anchor. Not a formal platform administrator.',
