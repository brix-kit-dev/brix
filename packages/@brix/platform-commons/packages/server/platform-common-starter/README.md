...
### 路由扫描配置 (brix.service.route-scan.*)
...
{
  "serviceName": "brix-service-user",
  "instanceId": "brix-service-user-host1-9010-abc123",
...
示例：
- `brix-service-user` - 用户服务
- `brix-service-contract` - 合同服务
- `brix-service-notification` - 通知服务
