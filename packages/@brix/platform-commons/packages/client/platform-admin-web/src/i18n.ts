...
export const I18N_KEYS = Object.freeze({
  ...
  login: {
    ...
    usernamePlaceholder: ['login.usernamePlaceholder', 'Enter admin email'],
    ...
    invalidCreds: ['login.invalidCreds', 'Invalid email or password'],
    mfaChallengeMissing: [
      'login.mfaChallengeMissing',
      'MFA challenge was not returned. Please sign in again.',
    ],
    requiredUsername: ['login.requiredUsername', 'Email address is required'],
    invalidEmail: ['login.invalidEmail', 'Enter a valid email address'],
