 ...
 * v3.2 采用三包分离架构，Hooks 实际定义在 @brix-sdk/platform-auth-ui-web。
 * 本文件提供向后兼容的重导出入口。
 * 
 * In v3.2 architecture, hooks are defined in @brix-sdk/platform-auth-ui-web.
 * This file provides backward-compatible re-exports.
 * 
 * @example
 * ```typescript
 * // Legacy import (still works)
 * import { useAuth, usePermission } from '@brix-sdk/platform-auth-web/hooks';
 * 
 * // Recommended: import directly from sub-package
 * import { useAuth, usePermission } from '@brix-sdk/platform-auth-ui-web';
 * ```
 */
